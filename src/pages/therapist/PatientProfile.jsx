...
export default function PatientProfile() {
  ...
  // Find oldest and latest non-null ROM evaluations in history
  ...
  // Find oldest and latest non-null Strength evaluations in history
      ...
      {activeTab === 'overview' && (
        <div className="animate-fade-in">
          ...
          <div className="grid-2 mb-4 animate-fade-in-up stagger-2" style={{ gap: 'var(--space-4)' }}>
            {/* Pain Chart */}
            <div className="card">
              <h3 className="section-title">מגמת כאב (14 ימים) - דיווח יומי</h3>
                ...
                <div style={{ width: '100%', height: 160 }}>
                  <ResponsiveContainer>
                    <LineChart data={metricsData}>
                      ...
                      />
                      <Line type="monotone" dataKey="rom" stroke="#06B6D4" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} name="ROM" connectNulls={true} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </div>
                ...
                <div style={{ width: '100%', height: 160 }}>
                  <ResponsiveContainer>
                    <LineChart data={metricsData}>
                      ...
                      />
                      <Line type="monotone" dataKey="strength" stroke="#8B5CF6" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 6 }} name="כוח שריר" connectNulls={true} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </div>
